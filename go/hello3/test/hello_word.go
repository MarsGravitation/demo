...
// 定义 ReadDir 的行为，固定返回了一个 inode:2 name 叫做 hello 的文件。
// 对应用户的行为一般是 ls 这个目录
...
// hello fs 文件系统中，File 结构实现了文件系统中关于文件的调用
type File struct{}
...
func (File) ReadAll(ctx concontext.context) ([]byte, error) {
